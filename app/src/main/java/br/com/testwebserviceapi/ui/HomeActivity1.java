...
public class HomeActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headerView(); // chamada do metodo que passa os parametros para o layout header
        ...
        /**btnAtualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(HomeActivity1.this, UpdateActivity.class);
    ...
    // metodo que passar parametros para o layout header
    ...
    public void onBackPressed() {
        final AlertDialog.Builder builder = new AlertDialog.Builder(HomeActivity1.this);
